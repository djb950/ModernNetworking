...
public protocol ModernNetworkProtocol {
    func request<T: Codable>(url: String, requestMethod: HTTPMethod, responseType: T.Type, queryItems: [URLQueryItem], requestBody: [String:Any], headers: [String:String]) async throws -> T?
}

open class ModernNetworking: ModernNetworkProtocol {
